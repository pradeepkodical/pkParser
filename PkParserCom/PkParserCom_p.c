...
/* Object interface: IParser, ver. 0.0,
   GUID={0x907ED02C,0xCE17,0x4E01,{0x97,0xED,0x22,0x82,0x45,0x58,0xB9,0x48}} */
...
CINTERFACE_PROXY_VTABLE(8) _IParserProxyVtbl = 
{
    &IParser_ProxyInfo,
    &IID_IParser,
...
const CInterfaceProxyVtbl * _PkParserCom_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IParserProxyVtbl,
    0
};

const CInterfaceStubVtbl * _PkParserCom_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IParserStubVtbl,
    0
};

PCInterfaceName const _PkParserCom_InterfaceNamesList[] = 
{
    "IParser",
    0
};

const IID *  _PkParserCom_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PkParserCom_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PkParserCom, pIID, n)

int __stdcall _PkParserCom_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PkParserCom_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PkParserCom_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PkParserCom_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PkParserCom_StubVtblList,
    (const PCInterfaceName * ) & _PkParserCom_InterfaceNamesList,
    (const IID ** ) & _PkParserCom_BaseIIDList,
    & _PkParserCom_IID_Lookup, 
    1,
    2,
